...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between min-h-[90vh] px-12 md:px-16 bg-gradient-to-br from-gray-800 to-black">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6 mt-32">
        ...
        <p className="text-lg text-gray-300 max-w-md mx-auto md:mx-0">
          Arte único, detalles que cuentan historias y diseños que marcan tu piel
          para siempre. Descubrí mi trabajo y llevá tu idea a la realidad.
        </p>
